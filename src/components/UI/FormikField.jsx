...
function FormikField({ setFieldValue, label, typeField, icon, parentClassName, options, ...props }) {
    ...
    const sharedStyles = `w-full p-3 bg-dark-06 border border-transparent rounded-md transition duration-300 ease-in-out read-only:border-transparent not-read-only:focus:border-orange-60`;
